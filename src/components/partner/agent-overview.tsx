      ...
      <section className="px-5 pt-10 pb-24 sm:px-6 lg:px-10 xl:px-12">
        <div className="mx-auto max-w-340">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            <StatCard icon={Building2} label="Active Properties" value={properties.length} />
            <StatCard icon={Inbox} label="New Enquiries" value={newEnquiries.length} />
            <StatCard icon={CalendarClock} label="Upcoming Viewings" value={upcomingViewings.length} />
            ...
            <div className="mt-8 grid gap-8 xl:grid-cols-[minmax(0,1.65fr)_minmax(320px,0.75fr)]">
              <div className="space-y-8">
                {attentionItems.length > 0 ? (
                  <section className="rounded-[1.75rem] bg-white shadow-[0_16px_45px_rgba(0,0,0,0.055)]">
